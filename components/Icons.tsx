...
export const BotIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    width="24" height="24"
  >
    <path d="M12 2a2 2 0 0 1 2 2v2a2 2 0 0 1-4 0V4a2 2 0 0 1 2-2zm0 18c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6zm0-10c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zM7 9a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm10 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0z" />
    <path d="M2.5 13.75a.75.75 0 0 0-1.5 0v1.5c0 .966.784 1.75 1.75 1.75h1.5a.75.75 0 0 0 0-1.5H3.25a.25.25 0 0 1-.25-.25v-1.5zM21.5 13.75a.75.75 0 0 0-1.5 0v1.5a.25.25 0 0 1-.25.25h-1.5a.75.75 0 0 0 0 1.5h1.5c.966 0 1.75-.784 1.75-1.75v-1.5z" />
  </svg>
);
...
export const PencilIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg>
);
...
export const Key: React.FC<{ className?: string }> = ({ className }) => (
    ...
    >
        ...
        <path d="M21 2l-6.5 6.5M15.5 7.5L12 12"></path>
    </svg>
);
...
// Export all icons as an object for easier imports
export const Icons = {
    BotIcon,
    UserIcon,
    PaperclipIcon,
